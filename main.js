...
const SCAN_Q = {
  ...
  wait: `
    ...
    WHERE waiting_tasks_count > 0 AND wait_type NOT IN (
      ...
      'SOS_WORK_DISPATCHER','QDS_SHUTDOWN_QUEUE','WAIT_XTP_RECOVERY','PVS_PREALLOCATE',
      'HADR_FILESTREAM_IOMGR_IOCOMPLETION','AZURE_IMDS_VERSIONS','VDI_CLIENT_OTHER','PREEMPTIVE_HADR_LEASE_MECHANISM','STARTUP_DEPENDENCY_MANAGER','PWAIT_EXTENSIBILITY_CLEANUP_TASK','CHKPT')
